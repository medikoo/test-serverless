...
`,F="	",E=")",b="x",f=4,x=/\n\n(?!\s*$)/,v=/^\[([ X\tx])][ \t]/,h=/^([ \t]*)([*+-]|\d+[.)])( {1,4}(?! )| |\t|$|(?=\n))([^\n]*)/,m=/^([ \t]*)([*+-]|\d+[.)])([ \t]+)/,C=/^( {1,4}|\t)?/gm;function w(O,T,P){for(var A=this,j=A.options.commonmark,V=A.options.pedantic,G=A.blockTokenizers,W=A.interruptList,R=0,J=T.length,z=null,M,U,k,y,_,N,H,X,K,Q,Y,ue,le,ce,te,Z,ee,De,ye,fe=!1,he,ae,pe,ne;R<J&&(y=T.charAt(R),!(y!==F&&y!==p));)R++;if(y=T.charAt(R),y===i||y===o||y===l)_=y,k=!1;else{for(k=!0,U="";R<J&&(y=T.charAt(R),!!a(y));)U+=y,R++;if(y=T.charAt(R),!U||!(y===d||j&&y===E)||P&&U!=="1")return;z=parseInt(U,10),_=y}if(y=T.charAt(++R),!(y!==p&&y!==F&&(V||y!==g&&y!==""))){if(P)return!0;for(R=0,ce=[],te=[],Z=[];R<J;){for(N=T.indexOf(g,R),H=R,X=!1,ne=!1,N===-1&&(N=J),M=0;R<J;){if(y=T.charAt(R),y===F)M+=f-M%f;else if(y===p)M++;else break;R++}if(ee&&M>=ee.indent&&(ne=!0),y=T.charAt(R),K=null,!ne){if(y===i||y===o||y===l)K=y,R++,M++;else{for(U="";R<J&&(y=T.charAt(R),!!a(y));)U+=y,R++;y=T.charAt(R),R++,U&&(y===d||j&&y===E)&&(K=y,M+=U.length+1)}if(K)if(y=T.charAt(R),y===F)M+=f-M%f,R++;else if(y===p){for(pe=R+f;R<pe&&T.charAt(R)===p;)R++,M++;R===pe&&T.charAt(R)===p&&(R-=f-1,M-=f-1)}else y!==g&&y!==""&&(K=null)}if(K){if(!V&&_!==K)break;X=!0}else!j&&!ne&&T.charAt(H)===p?ne=!0:j&&ee&&(ne=M>=ee.indent||M>f),X=!1,R=H;if(Y=T.slice(H,N),Q=H===R?Y:T.slice(R,N),(K===i||K===D||K===l)&&G.thematicBreak.call(A,O,Y,!0))break;if(ue=le,le=!X&&!u(Q).length,ne&&ee)ee.value=ee.value.concat(Z,Y),te=te.concat(Z,Y),Z=[];else if(X)Z.length!==0&&(fe=!0,ee.value.push(""),ee.trail=Z.concat()),ee={value:[Y],indent:M,trail:[]},ce.push(ee),te=te.concat(Z,Y),Z=[];else if(le){if(ue&&!j)break;Z.push(Y)}else{if(ue||c(W,G,A,[O,Y,!0]))break;ee.value=ee.value.concat(Z,Y),te=te.concat(Z,Y),Z=[]}R=N+1}for(he=O(te.join(g)).reset({type:"list",ordered:k,start:z,spread:fe,children:[]}),De=A.enterList(),ye=A.enterBlock(),R=-1,J=ce.length;++R<J;)ee=ce[R].value.join(g),ae=O.now(),O(ee)(q(A,ee,ae),he),ee=ce[R].trail.join(g),R!==J-1&&(ee+=g),O(ee);return De(),ye(),he}}function q(O,T,P){var A=O.offset,j=O.options.pedantic?L:B,V=null,G,W;return T=j.apply(null,arguments),O.options.gfm&&(G=T.match(v),G&&(W=G[0].length,V=G[1].toLowerCase()===b,A[P.line]+=W,T=T.slice(W))),{type:"listItem",spread:x.test(T),checked:V,children:O.tokenizeBlock(T,P)}}function L(O,T,P){var A=O.offset,j=P.line;return T=T.replace(m,V),j=P.line,T.replace(C,V);function V(G){return A[j]=(A[j]||0)+G.length,j++,""}}function B(O,T,P){var A=O.offset,j=P.line,V,G,W,R,J,z,M;for(T=T.replace(h,U),R=T.split(g),J=s(T,n(V).indent).split(g),J[0]=W,A[j]=(A[j]||0)+G.length,j++,z=0,M=R.length;++z<M;)A[j]=(A[j]||0)+R[z].length-J[z].length,j++;return J.join(g);function U(k,y,_,N,H){return G=y+_+N,W=H,Number(_)<10&&G.length%2===1&&(_=p+_),V=y+t(p,_.length)+N,V+W}}}}),dD=S({"node_modules/remark-parse/lib/tokenize/heading-setext.js"(e,r){"use strict";I(),r.exports=o;var u=`
...
`,s="<",c=/^<(script|pre|style)(?=(\s|>|$))/i,i=/<\/(script|pre|style)>/i,D=/^<!--/,o=/-->/,l=/^<\?/,d=/\?>/,p=/^<![A-Za-z]/,g=/>/,F=/^<!\[CDATA\[/,E=/]]>/,b=/^$/,f=new RegExp(u.source+"\\s*$");function x(v,h,m){for(var C=this,w=C.options.blocks.join("|"),q=new RegExp("^</?("+w+")(?=(\\s|/?>|$))","i"),L=h.length,B=0,O,T,P,A,j,V,G,W=[[c,i,!0],[D,o,!0],[l,d,!0],[p,g,!0],[F,E,!0],[q,b,!0],[f,b,!1]];B<L&&(A=h.charAt(B),!(A!==t&&A!==a));)B++;if(h.charAt(B)===s){for(O=h.indexOf(n,B+1),O=O===-1?L:O,T=h.slice(B,O),P=-1,j=W.length;++P<j;)if(W[P][0].test(T)){V=W[P];break}if(V){if(m)return V[2];if(B=O,!V[1].test(T))for(;B<L;){if(O=h.indexOf(n,B+1),O=O===-1?L:O,T=h.slice(B+1,O),V[1].test(T)){T&&(B=O);break}B=O}return G=h.slice(0,B),v(G)({type:"html",value:G})}}}}}),be=S({"node_modules/is-whitespace-character/index.js"(e,r){"use strict";I(),r.exports=a;var u=String.fromCharCode,t=/\s/;function a(n){return t.test(typeof n=="number"?u(n):n.charAt(0))}}}),vD=S({"node_modules/collapse-white-space/index.js"(e,r){"use strict";I(),r.exports=u;function u(t){return String(t).replace(/\s+/g," ")}}}),Hi=S({"node_modules/remark-parse/lib/util/normalize.js"(e,r){"use strict";I();var u=vD();r.exports=t;function t(a){return u(a).toLowerCase()}}}),mD=S({"node_modules/remark-parse/lib/tokenize/definition.js"(e,r){"use strict";I();var u=be(),t=Hi();r.exports=b;var a='"',n="'",s="\\",c=`
`,i="	",D=" ",o="[",l="]",d="(",p=")",g=":",F="<",E=">";function b(v,h,m){for(var C=this,w=C.options.commonmark,q=0,L=h.length,B="",O,T,P,A,j,V,G,W;q<L&&(A=h.charAt(q),!(A!==D&&A!==i));)B+=A,q++;if(A=h.charAt(q),A===o){for(q++,B+=A,P="";q<L&&(A=h.charAt(q),A!==l);)A===s&&(P+=A,q++,A=h.charAt(q)),P+=A,q++;if(!(!P||h.charAt(q)!==l||h.charAt(q+1)!==g)){for(V=P,B+=P+l+g,q=B.length,P="";q<L&&(A=h.charAt(q),!(A!==i&&A!==D&&A!==c));)B+=A,q++;if(A=h.charAt(q),P="",O=B,A===F){for(q++;q<L&&(A=h.charAt(q),!!f(A));)P+=A,q++;if(A=h.charAt(q),A===f.delimiter)B+=F+P+A,q++;else{if(w)return;q-=P.length+1,P=""}}if(!P){for(;q<L&&(A=h.charAt(q),!!x(A));)P+=A,q++;B+=P}if(P){for(G=P,P="";q<L&&(A=h.charAt(q),!(A!==i&&A!==D&&A!==c));)P+=A,q++;if(A=h.charAt(q),j=null,A===a?j=a:A===n?j=n:A===d&&(j=p),!j)P="",q=B.length;else if(P){for(B+=P+A,q=B.length,P="";q<L&&(A=h.charAt(q),A!==j);){if(A===c){if(q++,A=h.charAt(q),A===c||A===j)return;P+=c}P+=A,q++}if(A=h.charAt(q),A!==j)return;T=B,B+=P+A,q++,W=P,P=""}else return;for(;q<L&&(A=h.charAt(q),!(A!==i&&A!==D));)B+=A,q++;if(A=h.charAt(q),!A||A===c)return m?!0:(O=v(O).test().end,G=C.decode.raw(C.unescape(G),O,{nonTerminated:!1}),W&&(T=v(T).test().end,W=C.decode.raw(C.unescape(W),T)),v(B)({type:"definition",identifier:t(V),label:V,title:W||null,url:G}))}}}}function f(v){return v!==E&&v!==o&&v!==l}f.delimiter=E;function x(v){return v!==o&&v!==l&&!u(v)}}}),ED=S({"node_modules/remark-parse/lib/tokenize/table.js"(e,r){"use strict";I();var u=be();r.exports=F;var t="	",a=`
`,n=" ",s="-",c=":",i="\\",D="|",o=1,l=2,d="left",p="center",g="right";function F(E,b,f){var x=this,v,h,m,C,w,q,L,B,O,T,P,A,j,V,G,W,R,J,z,M,U,k;if(x.options.gfm){for(v=0,W=0,q=b.length+1,L=[];v<q;){if(M=b.indexOf(a,v),U=b.indexOf(D,v+1),M===-1&&(M=b.length),U===-1||U>M){if(W<l)return;break}L.push(b.slice(v,M)),W++,v=M+1}for(C=L.join(a),h=L.splice(1,1)[0]||[],v=0,q=h.length,W--,m=!1,P=[];v<q;){if(O=h.charAt(v),O===D){if(T=null,m===!1){if(k===!1)return}else P.push(m),m=!1;k=!1}else if(O===s)T=!0,m=m||null;else if(O===c)m===d?m=p:T&&m===null?m=g:m=d;else if(!u(O))return;v++}if(m!==!1&&P.push(m),!(P.length<o)){if(f)return!0;for(G=-1,J=[],z=E(C).reset({type:"table",align:P,children:J});++G<W;){for(R=L[G],w={type:"tableRow",children:[]},G&&E(a),E(R).reset(w,z),q=R.length+1,v=0,B="",A="",j=!0;v<q;){if(O=R.charAt(v),O===t||O===n){A?B+=O:E(O),v++;continue}O===""||O===D?j?E(O):((A||O)&&!j&&(C=A,B.length>1&&(O?(C+=B.slice(0,-1),B=B.charAt(B.length-1)):(C+=B,B="")),V=E.now(),E(C)({type:"tableCell",children:x.tokenizeInline(A,V)},w)),E(B+O),B="",A=""):(B&&(A+=B,B=""),A+=O,O===i&&v!==q-2&&(A+=R.charAt(v+1),v++)),j=!1,v++}G||E(a+h)}return z}}}}}),CD=S({"node_modules/remark-parse/lib/tokenize/paragraph.js"(e,r){"use strict";I();var u=ze(),t=Ui(),a=Eu();r.exports=D;var n="	",s=`
...
`+E.value+`
$$`}}}}),a2=S({"node_modules/remark-math/index.js"(e,r){I();var u=n2(),t=i2();r.exports=a;function a(n){var s=n||{};t.call(this,s),u.call(this,s)}}}),o2=S({"node_modules/remark-footnotes/index.js"(e,r){"use strict";I(),r.exports=g;var u=9,t=10,a=32,n=33,s=58,c=91,i=92,D=93,o=94,l=96,d=4,p=1024;function g(h){var m=this.Parser,C=this.Compiler;F(m)&&b(m,h),E(C)&&f(C)}function F(h){return Boolean(h&&h.prototype&&h.prototype.blockTokenizers)}function E(h){return Boolean(h&&h.prototype&&h.prototype.visitors)}function b(h,m){for(var C=m||{},w=h.prototype,q=w.blockTokenizers,L=w.inlineTokenizers,B=w.blockMethods,O=w.inlineMethods,T=q.definition,P=L.reference,A=[],j=-1,V=B.length,G;++j<V;)G=B[j],!(G==="newline"||G==="indentedCode"||G==="paragraph"||G==="footnoteDefinition")&&A.push([G]);A.push(["footnoteDefinition"]),C.inlineNotes&&(x(O,"reference","inlineNote"),L.inlineNote=J),x(B,"definition","footnoteDefinition"),x(O,"reference","footnoteCall"),q.definition=M,q.footnoteDefinition=W,L.footnoteCall=R,L.reference=z,w.interruptFootnoteDefinition=A,z.locator=P.locator,R.locator=U,J.locator=k;function W(y,_,N){for(var H=this,X=H.interruptFootnoteDefinition,K=H.offset,Q=_.length+1,Y=0,ue=[],le,ce,te,Z,ee,De,ye,fe,he,ae,pe,ne,re;Y<Q&&(Z=_.charCodeAt(Y),!(Z!==u&&Z!==a));)Y++;if(_.charCodeAt(Y++)===c&&_.charCodeAt(Y++)===o){for(ce=Y;Y<Q;){if(Z=_.charCodeAt(Y),Z!==Z||Z===t||Z===u||Z===a)return;if(Z===D){te=Y,Y++;break}Y++}if(!(te===void 0||ce===te||_.charCodeAt(Y++)!==s)){if(N)return!0;for(le=_.slice(ce,te),ee=y.now(),he=0,ae=0,pe=Y,ne=[];Y<Q;){if(Z=_.charCodeAt(Y),Z!==Z||Z===t)re={start:he,contentStart:pe||Y,contentEnd:Y,end:Y},ne.push(re),Z===t&&(he=Y+1,ae=0,pe=void 0,re.end=he);else if(ae!==void 0)if(Z===a||Z===u)ae+=Z===a?1:d-ae%d,ae>d&&(ae=void 0,pe=Y);else{if(ae<d&&re&&(re.contentStart===re.contentEnd||v(X,q,H,[y,_.slice(Y,p),!0])))break;ae=void 0,pe=Y}Y++}for(Y=-1,Q=ne.length;Q>0&&(re=ne[Q-1],re.contentStart===re.contentEnd);)Q--;for(De=y(_.slice(0,re.contentEnd));++Y<Q;)re=ne[Y],K[ee.line+Y]=(K[ee.line+Y]||0)+(re.contentStart-re.start),ue.push(_.slice(re.contentStart,re.end));return ye=H.enterBlock(),fe=H.tokenizeBlock(ue.join(""),ee),ye(),De({type:"footnoteDefinition",identifier:le.toLowerCase(),label:le,children:fe})}}}function R(y,_,N){var H=_.length+1,X=0,K,Q,Y,ue;if(_.charCodeAt(X++)===c&&_.charCodeAt(X++)===o){for(Q=X;X<H;){if(ue=_.charCodeAt(X),ue!==ue||ue===t||ue===u||ue===a)return;if(ue===D){Y=X,X++;break}X++}if(!(Y===void 0||Q===Y))return N?!0:(K=_.slice(Q,Y),y(_.slice(0,X))({type:"footnoteReference",identifier:K.toLowerCase(),label:K}))}}function J(y,_,N){var H=this,X=_.length+1,K=0,Q=0,Y,ue,le,ce,te,Z,ee;if(_.charCodeAt(K++)===o&&_.charCodeAt(K++)===c){for(le=K;K<X;){if(ue=_.charCodeAt(K),ue!==ue)return;if(Z===void 0)if(ue===i)K+=2;else if(ue===c)Q++,K++;else if(ue===D)if(Q===0){ce=K,K++;break}else Q--,K++;else if(ue===l){for(te=K,Z=1;_.charCodeAt(te+Z)===l;)Z++;K+=Z}else K++;else if(ue===l){for(te=K,ee=1;_.charCodeAt(te+ee)===l;)ee++;K+=ee,Z===ee&&(Z=void 0),ee=void 0}else K++}if(ce!==void 0)return N?!0:(Y=y.now(),Y.column+=2,Y.offset+=2,y(_.slice(0,K))({type:"footnote",children:H.tokenizeInline(_.slice(le,ce),Y)}))}}function z(y,_,N){var H=0;if(_.charCodeAt(H)===n&&H++,_.charCodeAt(H)===c&&_.charCodeAt(H+1)!==o)return P.call(this,y,_,N)}function M(y,_,N){for(var H=0,X=_.charCodeAt(H);X===a||X===u;)X=_.charCodeAt(++H);if(X===c&&_.charCodeAt(H+1)!==o)return T.call(this,y,_,N)}function U(y,_){return y.indexOf("[",_)}function k(y,_){return y.indexOf("^[",_)}}function f(h){var m=h.prototype.visitors,C="    ";m.footnote=w,m.footnoteReference=q,m.footnoteDefinition=L;function w(B){return"^["+this.all(B).join("")+"]"}function q(B){return"[^"+(B.label||B.identifier)+"]"}function L(B){for(var O=this.all(B).join(`
