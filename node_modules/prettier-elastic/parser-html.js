...
/**
	   ...
	   * found in the LICENSE file at https://angular.io/license
	   */
Object.defineProperty(t,"__esModule",{value:!0});t.AstPath=class{constructor(e,t=-1){this.path=e,this.position=t}get empty(){return!this.path||!this.path.length}get head(){return this.path[0]}get tail(){return this.path[this.path.length-1]}parentOf(e){return e&&this.path[this.path.indexOf(e)-1]}childOf(e){return this.path[this.path.indexOf(e)+1]}first(e){for(let t=this.path.length-1;t>=0;t--){let n=this.path[t];if(n instanceof e)return n}}push(e){this.path.push(e)}pop(){return this.path.pop()}}})),bn=t((function(e,t){
/**
	   * @license
	   * Copyright Google Inc. All Rights Reserved.
	   *
...
/**
	   ...
	   * found in the LICENSE file at https://angular.io/license
	   */
Object.defineProperty(t,"__esModule",{value:!0});class n{constructor(e,t){this.start=e,this.end=t}static fromArray(e){return e?(Fn.assertInterpolationSymbols("interpolation",e),new n(e[0],e[1])):t.DEFAULT_INTERPOLATION_CONFIG}}t.InterpolationConfig=n,t.DEFAULT_INTERPOLATION_CONFIG=new n("{{","}}")})),vn=t((function(e,t){
/**
	   * @license
	   * Copyright Google Inc. All Rights Reserved.
	   *
...
/**
	   ...
	   * found in the LICENSE file at https://angular.io/license
	   */
Object.defineProperty(t,"__esModule",{value:!0});class n extends o.ParseError{constructor(e,t,n){super(t,n),this.elementName=e}static create(e,t,r){return new n(e,t,r)}}t.TreeError=n;class r{constructor(e,t){this.rootNodes=e,this.errors=t}}t.ParseTreeResult=r;t.Parser=class{constructor(e){this.getTagDefinition=e}parse(e,t,n,i=!1,o){const a=e=>(t,...n)=>e(t.toLowerCase(),...n),u=i?this.getTagDefinition:a(this.getTagDefinition),c=e=>u(e).contentType,l=i?o:a(o),p=o?(e,t,n,r)=>{const s=l(e,t,n,r);return void 0!==s?s:c(e)}:c,h=vn.tokenize(e,t,p,n),D=n&&n.canSelfClose||!1,d=n&&n.allowHtmComponentClosingTags||!1,f=new s(h.tokens,u,D,d,i).build();return new r(f.rootNodes,h.errors.concat(f.errors))}};class s{constructor(e,t,n,r,s){this.tokens=e,this.getTagDefinition=t,this.canSelfClose=n,this.allowHtmComponentClosingTags=r,this.isTagNameCaseSensitive=s,this._index=-1,this._rootNodes=[],this._errors=[],this._elementStack=[],this._advance()}build(){for(;this._peek.type!==vn.TokenType.EOF;)this._peek.type===vn.TokenType.TAG_OPEN_START?this._consumeStartTag(this._advance()):this._peek.type===vn.TokenType.TAG_CLOSE?(this._closeVoidElement(),this._consumeEndTag(this._advance())):this._peek.type===vn.TokenType.CDATA_START?(this._closeVoidElement(),this._consumeCdata(this._advance())):this._peek.type===vn.TokenType.COMMENT_START?(this._closeVoidElement(),this._consumeComment(this._advance())):this._peek.type===vn.TokenType.TEXT||this._peek.type===vn.TokenType.RAW_TEXT||this._peek.type===vn.TokenType.ESCAPABLE_RAW_TEXT?(this._closeVoidElement(),this._consumeText(this._advance())):this._peek.type===vn.TokenType.EXPANSION_FORM_START?this._consumeExpansion(this._advance()):this._peek.type===vn.TokenType.DOC_TYPE_START?this._consumeDocType(this._advance()):this._advance();return new r(this._rootNodes,this._errors)}_advance(){const e=this._peek;return this._index<this.tokens.length-1&&this._index++,this._peek=this.tokens[this._index],e}_advanceIf(e){return this._peek.type===e?this._advance():null}_consumeCdata(e){const t=this._advance(),n=this._getText(t),r=this._advanceIf(vn.TokenType.CDATA_END);this._addToParent(new bn.CDATA(n,new o.ParseSourceSpan(e.sourceSpan.start,(r||t).sourceSpan.end)))}_consumeComment(e){const t=this._advanceIf(vn.TokenType.RAW_TEXT),n=this._advanceIf(vn.TokenType.COMMENT_END),r=null!=t?t.parts[0].trim():null,s=new o.ParseSourceSpan(e.sourceSpan.start,(n||t||e).sourceSpan.end);this._addToParent(new bn.Comment(r,s))}_consumeDocType(e){const t=this._advanceIf(vn.TokenType.RAW_TEXT),n=this._advanceIf(vn.TokenType.DOC_TYPE_END),r=null!=t?t.parts[0].trim():null,s=new o.ParseSourceSpan(e.sourceSpan.start,(n||t||e).sourceSpan.end);this._addToParent(new bn.DocType(r,s))}_consumeExpansion(e){const t=this._advance(),r=this._advance(),s=[];for(;this._peek.type===vn.TokenType.EXPANSION_CASE_VALUE;){const e=this._parseExpansionCase();if(!e)return;s.push(e)}if(this._peek.type!==vn.TokenType.EXPANSION_FORM_END)return void this._errors.push(n.create(null,this._peek.sourceSpan,"Invalid ICU message. Missing '}'."));const i=new o.ParseSourceSpan(e.sourceSpan.start,this._peek.sourceSpan.end);this._addToParent(new bn.Expansion(t.parts[0],r.parts[0],s,i,t.sourceSpan)),this._advance()}_parseExpansionCase(){const e=this._advance();if(this._peek.type!==vn.TokenType.EXPANSION_CASE_EXP_START)return this._errors.push(n.create(null,this._peek.sourceSpan,"Invalid ICU message. Missing '{'.")),null;const t=this._advance(),r=this._collectExpansionExpTokens(t);if(!r)return null;const i=this._advance();r.push(new vn.Token(vn.TokenType.EOF,[],i.sourceSpan));const a=new s(r,this.getTagDefinition,this.canSelfClose,this.allowHtmComponentClosingTags,this.isTagNameCaseSensitive).build();if(a.errors.length>0)return this._errors=this._errors.concat(a.errors),null;const u=new o.ParseSourceSpan(e.sourceSpan.start,i.sourceSpan.end),c=new o.ParseSourceSpan(t.sourceSpan.start,i.sourceSpan.end);return new bn.ExpansionCase(e.parts[0],a.rootNodes,u,e.sourceSpan,c)}_collectExpansionExpTokens(e){const t=[],r=[vn.TokenType.EXPANSION_CASE_EXP_START];for(;;){if(this._peek.type!==vn.TokenType.EXPANSION_FORM_START&&this._peek.type!==vn.TokenType.EXPANSION_CASE_EXP_START||r.push(this._peek.type),this._peek.type===vn.TokenType.EXPANSION_CASE_EXP_END){if(!i(r,vn.TokenType.EXPANSION_CASE_EXP_START))return this._errors.push(n.create(null,e.sourceSpan,"Invalid ICU message. Missing '}'.")),null;if(r.pop(),0==r.length)return t}if(this._peek.type===vn.TokenType.EXPANSION_FORM_END){if(!i(r,vn.TokenType.EXPANSION_FORM_START))return this._errors.push(n.create(null,e.sourceSpan,"Invalid ICU message. Missing '}'.")),null;r.pop()}if(this._peek.type===vn.TokenType.EOF)return this._errors.push(n.create(null,e.sourceSpan,"Invalid ICU message. Missing '}'.")),null;t.push(this._advance())}}_getText(e){let t=e.parts[0];if(t.length>0&&"\n"==t[0]){const e=this._getParentElement();null!=e&&0==e.children.length&&this.getTagDefinition(e.name).ignoreFirstLf&&(t=t.substring(1))}return t}_consumeText(e){const t=this._getText(e);t.length>0&&this._addToParent(new bn.Text(t,e.sourceSpan))}_closeVoidElement(){const e=this._getParentElement();e&&this.getTagDefinition(e.name).isVoid&&this._elementStack.pop()}_consumeStartTag(e){const t=e.parts[0],r=e.parts[1],s=[];for(;this._peek.type===vn.TokenType.ATTR_NAME;)s.push(this._consumeAttr(this._advance()));const i=this._getElementFullName(t,r,this._getParentElement());let a=!1;if(this._peek.type===vn.TokenType.TAG_OPEN_END_VOID){this._advance(),a=!0;const t=this.getTagDefinition(i);this.canSelfClose||t.canSelfClose||null!==Tn.getNsPrefix(i)||t.isVoid||this._errors.push(n.create(i,e.sourceSpan,'Only void and foreign elements can be self closed "'.concat(e.parts[1],'"')))}else this._peek.type===vn.TokenType.TAG_OPEN_END&&(this._advance(),a=!1);const u=this._peek.sourceSpan.start,c=new o.ParseSourceSpan(e.sourceSpan.start,u),l=new o.ParseSourceSpan(e.sourceSpan.start.moveBy(1),e.sourceSpan.end),p=new bn.Element(i,s,[],c,c,void 0,l);this._pushElement(p),a&&(this._popElement(i),p.endSourceSpan=c)}_pushElement(e){const t=this._getParentElement();t&&this.getTagDefinition(t.name).isClosedByChild(e.name)&&this._elementStack.pop(),this._addToParent(e),this._elementStack.push(e)}_consumeEndTag(e){const t=this.allowHtmComponentClosingTags&&0===e.parts.length?null:this._getElementFullName(e.parts[0],e.parts[1],this._getParentElement());if(this._getParentElement()&&(this._getParentElement().endSourceSpan=e.sourceSpan),t&&this.getTagDefinition(t).isVoid)this._errors.push(n.create(t,e.sourceSpan,'Void elements do not have end tags "'.concat(e.parts[1],'"')));else if(!this._popElement(t)){const r='Unexpected closing tag "'.concat(t,'". It may happen when the tag has already been closed by another tag. For more info see https://www.w3.org/TR/html5/syntax.html#closing-elements-that-have-implied-end-tags');this._errors.push(n.create(t,e.sourceSpan,r))}}_popElement(e){for(let t=this._elementStack.length-1;t>=0;t--){const n=this._elementStack[t];if(!e||(Tn.getNsPrefix(n.name)?n.name==e:n.name.toLowerCase()==e.toLowerCase()))return this._elementStack.splice(t,this._elementStack.length-t),!0;if(!this.getTagDefinition(n.name).closedByParent)return!1}return!1}_consumeAttr(e){const t=Tn.mergeNsAndName(e.parts[0],e.parts[1]);let n=e.sourceSpan.end,r="",s=void 0,i=void 0;if(this._peek.type===vn.TokenType.ATTR_QUOTE){i=this._advance().sourceSpan.start}if(this._peek.type===vn.TokenType.ATTR_VALUE){const e=this._advance();r=e.parts[0],n=e.sourceSpan.end,s=e.sourceSpan}if(this._peek.type===vn.TokenType.ATTR_QUOTE){n=this._advance().sourceSpan.end,s=new o.ParseSourceSpan(i,n)}return new bn.Attribute(t,r,new o.ParseSourceSpan(e.sourceSpan.start,n),s,e.sourceSpan)}_getParentElement(){return this._elementStack.length>0?this._elementStack[this._elementStack.length-1]:null}_getParentElementSkippingContainers(){let e=null;for(let t=this._elementStack.length-1;t>=0;t--){if(!Tn.isNgContainer(this._elementStack[t].name))return{parent:this._elementStack[t],container:e};e=this._elementStack[t]}return{parent:null,container:e}}_addToParent(e){const t=this._getParentElement();null!=t?t.children.push(e):this._rootNodes.push(e)}_insertBeforeContainer(e,t,n){if(t){if(e){const r=e.children.indexOf(t);e.children[r]=n}else this._rootNodes.push(n);n.children.push(t),this._elementStack.splice(this._elementStack.indexOf(t),0,n)}else this._addToParent(n),this._elementStack.push(n)}_getElementFullName(e,t,n){return""===e&&""===(e=this.getTagDefinition(t).implicitNamespacePrefix||"")&&null!=n&&(e=Tn.getNsPrefix(n.name)),Tn.mergeNsAndName(e,t)}}function i(e,t){return e.length>0&&e[e.length-1]===t}})),kn=t((function(e,t){
/**
	   * @license
	   * Copyright Google Inc. All Rights Reserved.
	   *
	   ...
	   * found in the LICENSE file at https://angular.io/license
	   */
Object.defineProperty(t,"__esModule",{value:!0});var n=wn;t.ParseTreeResult=n.ParseTreeResult,t.TreeError=n.TreeError;class r extends wn.Parser{constructor(){super(Sn.getHtmlTagDefinition)}parse(e,t,n,r=!1,s){return super.parse(e,t,n,r,s)}}t.HtmlParser=r})),Nn=t((function(e,t){Object.defineProperty(t,"__esModule",{value:!0}),t.TagContentType=Tn.TagContentType;let n=null;t.parse=function(e,t={}){const{canSelfClose:r=!1,allowHtmComponentClosingTags:s=!1,isTagNameCaseSensitive:i=!1,getTagContentType:o}=t;return(n||(n=new kn.HtmlParser),n).parse(e,"angular-html-parser",{tokenizeExpansionForms:!1,interpolationConfig:void 0,canSelfClose:r,allowHtmComponentClosingTags:s},i,o)}}));const{ParseSourceSpan:xn,ParseLocation:On,ParseSourceFile:Rn}=o,{parse:Ln}=Nt,{inferParserByLanguage:Pn}=We,{HTML_ELEMENT_ATTRIBUTES:Bn,HTML_TAGS:In,isUnknownNamespace:qn}=ln,{hasPragma:$n}=pn,{Node:Mn}=mn,{parseIeConditionalComment:Un}=Cn,{locStart:Gn,locEnd:Vn}=yn;function jn(e,{recognizeSelfClosing:t,normalizeTagName:n,normalizeAttributeName:r,allowHtmComponentClosingTags:s,isTagNameCaseSensitive:i,getTagContentType:a},u){const c=Nn,{RecursiveVisitor:l,visitAll:p,Attribute:h,CDATA:D,Comment:d,DocType:f,Element:m,Text:g}=bn,{ParseSourceSpan:E}=o,{getHtmlTagDefinition:C}=Sn;let{rootNodes:y,errors:T}=c.parse(e,{canSelfClose:t,allowHtmComponentClosingTags:s,isTagNameCaseSensitive:i,getTagContentType:a});const S="vue"===u.parser&&y.some((e=>e instanceof f&&"html"===e.value||e instanceof m&&"html"===e.name.toLowerCase()));if("vue"!==u.parser||S){if(S){t=!0,n=!0,r=!0,s=!0,i=!1;const o=c.parse(e,{canSelfClose:t,allowHtmComponentClosingTags:s,isTagNameCaseSensitive:i});y=o.rootNodes,T=o.errors}}else{const n=e=>{if(!e)return!1;if("template"!==e.name)return!1;const t=e.attrs.find((e=>"lang"===e.name)),n=t&&t.value;return null==n||"html"===Pn(n,u)};if(y.some(n)){let r;const o=()=>c.parse(e,{canSelfClose:t,allowHtmComponentClosingTags:s,isTagNameCaseSensitive:i}),a=()=>r||(r=o()),u=e=>a().rootNodes.find((({startSourceSpan:t})=>t&&t.start.offset===e.startSourceSpan.start.offset));for(let e=0;e<y.length;e++){const t=y[e],{endSourceSpan:r,startSourceSpan:s}=t;if(null===r){T=a().errors,y[e]=u(t)||t}else if(n(t)){const n=a(),i=s.end.offset,o=r.start.offset;for(const e of n.errors){const{offset:t}=e.span.start;if(i<t&&t<o){T=[e];break}}y[e]=u(t)||t}}}}if(0!==T.length){const{msg:e,span:{start:t,end:n}}=T[0];throw xt(e,{start:{line:t.line+1,column:t.col+1},end:{line:n.line+1,column:n.col+1}})}const _=e=>{const t=e.name.startsWith(":")?e.name.slice(1).split(":")[0]:null,n=e.nameSpan.toString(),r=n.startsWith("".concat(t,":")),s=r?n.slice(t.length+1):n;e.name=s,e.namespace=t,e.hasExplicitNamespace=r},b=(e,t)=>{const n=e.toLowerCase();return t(n)?n:e};return p(new class extends l{visit(e){(e=>{if(e instanceof h)e.type="attribute";else if(e instanceof D)e.type="cdata";else if(e instanceof d)e.type="comment";else if(e instanceof f)e.type="docType";else if(e instanceof m)e.type="element";else{if(!(e instanceof g))throw new Error("Unexpected node ".concat(JSON.stringify(e)));e.type="text"}})(e),(e=>{e instanceof m?(_(e),e.attrs.forEach((e=>{_(e),e.valueSpan?(e.value=e.valueSpan.toString(),/["']/.test(e.value[0])&&(e.value=e.value.slice(1,-1))):e.value=null}))):e instanceof d?e.value=e.sourceSpan.toString().slice("\x3c!--".length,-"--\x3e".length):e instanceof g&&(e.value=e.sourceSpan.toString())})(e),(e=>{if(e instanceof m){const t=C(i?e.name:e.name.toLowerCase());!e.namespace||e.namespace===t.implicitNamespacePrefix||qn(e)?e.tagDefinition=t:e.tagDefinition=C("")}})(e),(e=>{if(e instanceof m&&(!n||e.namespace&&e.namespace!==e.tagDefinition.implicitNamespacePrefix&&!qn(e)||(e.name=b(e.name,(e=>e in In))),r)){const t=Bn[e.name]||Object.create(null);e.attrs.forEach((n=>{n.namespace||(n.name=b(n.name,(n=>e.name in Bn&&(n in Bn["*"]||n in t))))}))}})(e),(e=>{e.sourceSpan&&e.endSourceSpan&&(e.sourceSpan=new E(e.sourceSpan.start,e.endSourceSpan.end))})(e)}},y),y}function Hn(e,t,n,r=!0){const{frontMatter:s,content:i}=r?Ln(e):{frontMatter:null,content:e},o=new Rn(e,t.filepath),a=new On(o,0,0,0),u=a.moveBy(e.length),c={type:"root",sourceSpan:new xn(a,u),children:jn(i,n,t)};if(s){const e=new On(o,0,0,0),t=e.moveBy(s.raw.length);s.sourceSpan=new xn(e,t),c.children.unshift(s)}const l=new Mn(c),p=(r,s)=>{const{offset:i}=s,o=Hn(e.slice(0,i).replace(/[^\n\r]/g," ")+r,t,n,!1);o.sourceSpan=new xn(s,o.children[o.children.length-1].sourceSpan.end);const a=o.children[0];return a.length===i?o.children.shift():(a.sourceSpan=new xn(a.sourceSpan.start.moveBy(i),a.sourceSpan.end),a.value=a.value.slice(i)),o};return l.map((e=>{if("comment"===e.type){const t=Un(e,p);if(t)return t}return e}))}function Xn({recognizeSelfClosing:e=!1,normalizeTagName:t=!1,normalizeAttributeName:n=!1,allowHtmComponentClosingTags:r=!1,isTagNameCaseSensitive:s=!1,getTagContentType:i}={}){return{parse:(o,a,u)=>Hn(o,u,{recognizeSelfClosing:e,normalizeTagName:t,normalizeAttributeName:n,allowHtmComponentClosingTags:r,isTagNameCaseSensitive:s,getTagContentType:i}),hasPragma:$n,astFormat:"html",locStart:Gn,locEnd:Vn}}return{parsers:{html:Xn({recognizeSelfClosing:!0,normalizeTagName:!0,normalizeAttributeName:!0,allowHtmComponentClosingTags:!0}),angular:Xn(),vue:Xn({recognizeSelfClosing:!0,isTagNameCaseSensitive:!0,getTagContentType:(e,t,n,r)=>{if("html"!==e.toLowerCase()&&!n&&("template"!==e||r.some((({name:e,value:t})=>"lang"===e&&"html"!==t))))return Nn.TagContentType.RAW_TEXT}}),lwc:Xn()}}}));
